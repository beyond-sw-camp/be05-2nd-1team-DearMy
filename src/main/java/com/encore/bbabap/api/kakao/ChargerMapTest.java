...
@Tag(name = "충전기 정보 API", description = "충전기 정보를 가져오는 API")
...
//    @GetMapping("/xmlapi")
//    @Operation(summary = "XML API 호출", description = "XML 형식으로 API를 호출")
...
//    @GetMapping("/jsonapi")
//    @Operation(summary = "JSON API 호출", description = "JSON 형식으로 API를 호출")
...
//    @Operation(summary = "실제 API 데이터 호출", description = "실제 API 데이터를 호출")
...
//    }//method end
    ...
    @Operation(summary = "데이터 필터링", description = "API에서 필터링을 거쳐 데이터를 호출")
    ...
    @Operation(summary = "특정 지역의 데이터 호출", description = "특정 지역을 기반으로 API 데이터를 호출")
